...
namespace MUnique.OpenMU.Launcher.Helpers.Torrent.BEncoding
{
    ...
    public class BEncodedList : BEncodedValue, IList<BEncodedValue>, IEnumerable
    {
        ...
        /// <returns>
        ///     true if <paramref name="item" /> was successfully removed from the <see cref="System.Collections.Generic.ICollection`1" />; otherwise, false. This method also returns false if
