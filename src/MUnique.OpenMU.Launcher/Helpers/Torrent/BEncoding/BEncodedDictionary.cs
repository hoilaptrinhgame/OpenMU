...
namespace MUnique.OpenMU.Launcher.Helpers.Torrent.BEncoding
{
    ...
    public class BEncodedDictionary : BEncodedValue, IDictionary<BEncodedString, BEncodedValue>
    {
        ...
        /// <value>
        ///     true if the element is successfully removed; otherwise, false.  This method also value false if <paramref name="key" /> was not found in the original
        ...
        /// <value>
        ///     true if <paramref name="item" /> was successfully removed from the <see cref="System.Collections.Generic.ICollection`1" />; otherwise, false. This method also value false if
        ...
        /// <param name="value">
        ///     When this method value, the value associated with the specified key, if the key is found; otherwise, the default value for the type of the
