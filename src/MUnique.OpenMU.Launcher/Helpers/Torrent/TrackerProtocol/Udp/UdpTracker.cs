...
namespace MUnique.OpenMU.Launcher.Helpers.Torrent.TrackerProtocol.Udp
{
    /// <summary>
    ///     The UDP tracker.
    /// </summary>
    public sealed class UdpTracker : Tracker
    {
        ...
        protected override void OnAnnounce()
        {
            ...
            message = new AnnounceMessage(connectionId, transactionId, TorrentInfoHash, PeerId, BytesDownloaded, BytesLeftToDownload, BytesUploaded, TrackingEvent, 0,
                WantedPeerCount, new IPEndPoint(IPAddress.Loopback, ListeningPort));
            ...
            if (message is AnnounceResponseMessage)
            {
                ...
                OnAnnounced(this,
                    new AnnouncedEventArgs(message.As<AnnounceResponseMessage>().Interval, message.As<AnnounceResponseMessage>().LeecherCount,
